...
class SoldTablesAccessorySellers extends StatelessWidget {
  static const String routeName = "sold_tables_accessory_sellers";

  const SoldTablesAccessorySellers({Key? key}) : super(key: key);
