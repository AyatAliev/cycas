...
class SoldTablesPhoneSellers extends StatelessWidget {
  static const String routeName = "sold_tables_phone_sellers";

  const SoldTablesPhoneSellers({Key? key}) : super(key: key);
